...
export declare class SenderLayer extends ListenerLayer {
    ...
    sendMessageOptions(chat: any, content: any, options?: any): Promise<any>;
    /**
     * Sends image message
     * @param to Chat id
     ...
     * @param caption
     */
    sendImage(to: string, filePath: string, filename?: string, caption?: string): Promise<unknown>;
    /**
     * Sends image message
     * @param to Chat id
     ...
     * @param caption
     */
    sendImageFromBase64(to: string, base64: string, filename: string, caption?: string): Promise<unknown>;
    /**
